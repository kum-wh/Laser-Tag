...
def main():
    ...
    for i in range(5):
        ...
        if i == 0:
            ...
            for j in range(50):
                x.append(n_action[j][0])
                y.append(n_action[j][1])
                z.append(n_action[j][2])
                gx.append(n_action[j][3])
                gy.append(n_action[j][4])
                gz.append(n_action[j][5])
