...
class GameState:
    ...
    # New
    def update_players(self, action: str):
        player, player_action = action.split(" ")
        if player == "1":
            self.player_1.update(0, 0, player_action, "none", True)
            # self.player_1.update(player_action)
        elif player == "2":
            self.player_2.update(0, 0, player_action, "none", True)
            # self.player_2.update(player_action)
